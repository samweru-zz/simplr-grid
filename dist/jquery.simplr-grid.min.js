...
!function(p) {
    var u = {
        addRow: function(e, t, s) {
            ...
            return r.append(o.html(e)), s.dblClick && r.dblclick(s.dblClick), r.click(function() {
                ...
                var a = {};
                if (!p.isEmptyObject(s.columns)) {
                    var n = s.columns[e];
                    void 0 !== n && n.hasOwnProperty("css") && (a = n.css || a);
                }
                o = p(document.createElement("TD")).attr("name", e).css(a), s.resizeColumns ? o.html(p(document.createElement("DIV")).html(t)) : o.html(t), 
                r.append(o);
            }), r;
        },
        ...
        buildHeader: function(e, t, o) {
            var i = p(document.createElement("THEAD")), a = p(document.createElement("TH"));
            return i.append(a.html("&nbsp;")), p.each(t[0], function(e, t) {
                var a = {}, n = "";
                if (!p.isEmptyObject(o.columns) && o.columns.hasOwnProperty(e)) {
                    var s = o.columns[e];
                    n = s.name || e, s.hasOwnProperty("css") && s.css.hasOwnProperty("display") && "none" == s.css.display.toLowerCase().trim() && (a = {
                        display: "none"
                    });
                }
                if (!n) {
                    var r = e.split("_");
                    n = 1 < r.length ? r.map(function(e) {
                        return e[0].toUpperCase() + e.substring(1);
                    }).join(" ") : e[0].toUpperCase() + e.substring(1);
                }
                i.append(p(document.createElement("TH")).attr("name", e).html(n).css(a));
            }), 0 < t.length && (e.append(i), !0);
        },
        ...
        buildToolbars: function(e, t, a) {
            var n = p(document.createElement("DIV"));
            n.addClass("simplr-grid-capsule"), n.css({
                width: a.css.capsuleWidth
            }), e.css({
                width: a.css.gridWidth
            });
            var s = e.data("options");
            e.replaceWith(n), //replace erases options
            e.data("options", s), e.bind("refresh", function() {
                u.loader(e, e.data("options"), u.rebuildBody);
            });
            var r = p(document.createElement("DIV"));
            r.addClass("simplr-grid-title"), r.html("&nbsp;".concat(a.title));
            var o = p(document.createElement("DIV"));
            o.addClass("simplr-grid-inner"), o.css({
                height: a.css.gridHeight
            }), n.append(r), p.each(a.toolbars, function(e, t) {
                n.append(u.addToolbar(t));
            }), a.usePager && n.append(u.buildPager(e, a)), n.append(o), o.append(e);
        },
        disableToolbar: function(e, t) {
            var a = e.parent().prev();
            if (a.find(".sg-last, .sg-next, .sg-prev, .sg-first, .page-num, select").attr("disabled", t), 
            t) {
                var n = p("<div>").addClass("msg-outer"), s = p("<div>").addClass("msg-inner").html("No Data");
                e.parent().not(":has(.msg-outer)").append(n.append(s)), 
                // toolbar.find(".page-num").val("") <-- never uncomment this loader will not load data
                a.find(".num-of-pages").html("#");
            } else e.parent().find(".msg-outer").remove();
        },
    ...
    p.fn.simplrGrid = function(e) {
        ...
        return p(this).has("td").find("td:not(:first-child)").each(function(e, t) {
            var a = p(t).attr("name");
            p(this).has("div").length ? val = p(this).find("div").html() : val = p(this).html(), 
            n[a] = val;
        }), n;
        ...
        return this.each(function() {
            ...
            e = p(this), (t = e.parent()).append(e), t.css({
                ...
                var e = t.scrollLeft();
                0 < l.left && l.leftColumns.css("left", e);
            }.bind(e)), a = p(this), l.leftColumns = p(), a.find("tr").each(function(e, t) {
                !function(e, t) {
                    for (var a = l.left, n = 1, s = 1; s <= a; s += n) {
                        var r = 1 < n ? s - 1 : s, o = p(e).find("> *:nth-child(" + r + ")"), i = o.prop("colspan");
                        t(o), n = i;
                    }
                }(t, function(e) {
                    l.leftColumns = l.leftColumns.add(e);
                });
            }), l.leftColumns.each(function(e, t) {
                var t = p(t);
                t.css({
                    position: "relative"
                });
